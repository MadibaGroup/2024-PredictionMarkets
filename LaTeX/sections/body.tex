...
\begin{enumerate}
  ...
  \item \textbf{Designated arbiter:} final authority is a specific signing address; behind this address could be a trusted organization (\eg AP via Everipedia OraQles) or a GenAI (\eg Grok for Polymarket)  
