...
%	6.	Auditability \& logs.
%Persist the payout vector, resolution block/time, and redeemed vs redeemable totals on-chain; append-only edit logs for clarifications.
%• Polymarket: UMA ancillaryData + adapter write; Gamma indexes extra metadata off-chain.
%• Omen: Realitio question/answer history on-chain + subgraph.
%• Augur: on-chain dispute history.
