...
Due to page restrictions, we relegate the designs for the market topic to Appendix~\ref{app:topic}. It describes the differences between permissioned and permissionless systems for setting up what the market is about. It also provides important real-world examples of ill-defined market topics that have proven to be problematic. It provides an insight and a research gap related to these points. 
