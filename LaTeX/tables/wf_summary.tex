...
\begin{tabularx}{\textwidth}{|p{1.6cm}|C|C|C|C|C|C|C|C|C|C|}
\hline
\multicolumn{1}{|c|}{\rotheader{Platform}} & \multicolumn{1}{|c|}{\rotheader{Infrastucture}}  & \rotheader{Topic} & \rotheader{Share} & \rotheader{Initial Issuance} & \rotheader{Numeraire} & \rotheader{Trading} & \rotheader{Resolution} & \rotheader{Settle} & \rotheader{Archive} & \rotheader{Implementation} \\
\hline
Augur (v1) & ETH L1 & \Circle & WTA & Split & ETH & O-OB & REP & PL & L & P + S \\
\hline
Princeton PM (design) & ETH L1 & \Circle & WTA & Split & --- & O-OB & C & PL & L & P \\
\hline
...
\hline
Polymarket & Polygon (L2) & \CIRCLE\ (+ Pilot) & YNB & Split & USDC & X + A & UMA & PL + XG & L & P + S \\
\hline
Hivemind (Truthcoin) & BTC-side & \Circle & Comb. & CF: LSMR & --- & A & VTC & PL & S & P \\
\hline
PlotX (v2) & Polygon (L2) & \Circle & B/S & CF: CFMM & USDC & A & Ext.O & PL & P & S \\
\hline
CePM: Kalshi & CEX Deri & \CIRCLE\ (Rulebook) & Binary & Admin & USD & C & C & PS & C & S \\
\hline
CePM: PredictIt & CEX Retail & \CIRCLE\ (Operator) & Binary & Admin & USD & C & C & PS & C & S \\
\hline
\end{tabularx}
