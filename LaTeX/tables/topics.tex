...
\multirow{2}{\linewidth}{Borderline Categories [Def'n]}
...
\multirow{2}{\linewidth}{Precedence Gaps [Def'n]}
...
\multirow{2}{\linewidth}{Hidden Presumptions [Def'n]}
...
\multirow{2}{\linewidth}{No Ground Truth [Topic]}
...
\multirow{2}{\linewidth}{Platform Coupling [Topic]}
